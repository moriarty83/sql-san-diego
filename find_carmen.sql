...
-- ANSWER: code: VAT, name: Holy See (Vatican City State)
...
SELECT * FROM country LEFT JOIN city ON  country.capital = city.id WHERE country.code = 'BRA';
-- Answer: Brasília, City Code 211
